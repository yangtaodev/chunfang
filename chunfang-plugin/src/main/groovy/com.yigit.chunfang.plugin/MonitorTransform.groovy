...
import com.yigit.plugin.TimeStatisticsClassVisitor
...
public class MonitorTransform extends Transform {
        ...
        if (directoryInput.file.isDirectory()) {
            ...
            directoryInput.file.eachFileRecurse { File file ->
                ...
                if (checkClassFile(name)) {
                    ...
                    ClassVisitor cv = new TimeStatisticsClassVisitor(classWriter)
    ...
    public boolean isMatchPackagePrefix(String name) {
        if (mPackagePrefixsWhiteList == null || mPackagePrefixsWhiteList.length == 0) {
            return false;
        }
